...
ANCESTRIES = [
    ...
    ("dwarvenkind", "Dwarvenkind", "Rune-Keepers from across the forgotten sea",
     "Stubborn, skilled, remembering a Great Sea they can no longer reach. Sidelined coastal peoples in the old Empire, they held the line through the climb up the Venturer's Trail and built Hvergi on their own terms in the eastern peaks.",
     "Their crystal seams beneath the Teardrops feed the Academy's Lumen-craft. They know exactly what that leverage is worth, and they manage it carefully. The rivalry with House Thalum over quarry rights has run for generations and shows no sign of ending.",
...
COMMUNITIES = [
    ...
    ("Seaborne", "Cultural memory of the Dwarven Great Sea or lost Armisian coastlines — water in a world that has none."),
...
PLACES = [
    ...
    ("hvergi",        "Hvergi",
     "A Dwarvish stronghold in the eastern peaks, built on their own terms after the climb up the Venturer's Trail. The crystal seams beneath it feed the Academy's Lumen-craft. They know exactly what that leverage is worth."),
    ("ruin",          "Aeldenbarrows",
