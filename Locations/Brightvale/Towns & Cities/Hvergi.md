...
The Dwarven enclave of **Hvergi** is carved into the eastern mountain-roots of Brightvale's plateau — a settlement that functions as mine, fortress, and cultural heartland in equal measure. Founded approximately **25 AA** by [[Dwarvenkind|Dwarven]] refugees consolidating their mining operations, Hvergi has grown steadily into the most self-sufficient non-human settlement in the Vale.

---

## The Deep Mines

Hvergi's primary output is the **crystal seams** found deep beneath the mountains. These crystals serve two critical purposes:

- **Arcane Focus:** [[Aetherweaver Academy|Aetherweavers]] throughout the Vale rely on Hvergi crystals to channel and manipulate the Beacon's light. Without them, most applied aetherweaving would be significantly less precise.
- **Latent Energy:** Certain crystals contain stored magical energy that can be drawn upon to create enchanted items, or deliberately released in a concentrated burst. The Dwarves understand the extraction process better than anyone in the Vale and share this knowledge sparingly.

This gives Hvergi quiet but substantial leverage over the Vale's arcane economy — leverage the Dwarves manage carefully and without fanfare.

---

## The Northeastern Tunnel

What [[Medsen]] does not yet fully know — and what the Dwarves have no intention of announcing — is that Hvergi has been **secretly mining a tunnel to the northeast** for an undisclosed period.

The project has two motivations:
